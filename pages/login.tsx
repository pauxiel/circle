    ...
    <>
      ...
      <section className="grid grid-cols-2 z-10">
        <div className="left-side h-screen">
          ...
          <div className="flex py-20 px-8 ">
            <div className="flex items-start relative">
              ...
              <div className="heading font-Outfit px-6">
                ...
                <p className="text-xl">
                  Join the talent-driven communites and members and find
                  opportunites{' '}
                </p>
              </div>
            </div>
          ...
          <form
            className=" px-16 w-full space-y-8 pb-2"
          ...
          >
            ...
            <button
              className="bg-blue-600 rounded-md w-full py-3 px-2 text-white"
              type="submit"
            >
              Get Started
            </button>
        ...
        <div className="right-side h-screen bg-gray-100 flex justify-end">
          <Image src={SignBg.src} alt="the whatnew icon" />
        </div>
      </section>
