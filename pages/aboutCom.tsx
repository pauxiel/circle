...
function AboutCom() {
  ...
  const { data, error } = useSWR('/api/getCommProfile', fetcher)
      ...
      <div className="flex flex-col h-screen">
        ...
        <div className="flex items-center px-6 mb-6 ">
          ...
          <div className="button border ml-auto px-6 py-2 flex items-center rounded-full font-Outfit hover:bg-blue-600 hover:text-white shadow-md">
            <Link href="/editCommProfile">Edit Profile</Link>
          </div>
        </div>

        <div className="user-details px-6 mb-4 ">
          <h1 className="font-bold text-2xl">{data.commName}</h1>
        ...
        <div className="user-category px-6 mb-6 flex  items-center space-x-4">
          <div className="flex items-center space-x-2">
            <Image
              ...
              className=""
            />
            <span className="text-blue-500">{data.commType}</span>
          </div>
  ...
  className=""
      ...
      <span className="text-blue-500"> harrythecooker.io</span>
        ...
        <div className="user-details px-6 mb-4 ">
          ...
          <p className="text-sm text-gray-400 leading-4">{data.commAbout}</p>
        </div>
