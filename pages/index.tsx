      ...
      <div className="feed-section-loop  border-b">
        <div className="feed space-y-4 px-8 py-6 ">
          ...
          <div className="post-caption">
            <p>
              Hey y’all, Here is the link to the documentations for the spotify
              document. Do well to check it out so you can get more light on how
              to use it correctly.
            </p>
          </div>

          <a
            className="link flex items-center  p-3 bg-gray-50 hover:bg-gray-100 border space-x-3 rounded-md"
            href="#"
          >
            <Image
              src={Link}
            ...
            <div className="text-heading">
              <h1 className="text-md font-bold">
                You will be directed out of circcle when you click this link
              </h1>
